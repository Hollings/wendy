...
**YOU ARE IN: `wendy_v2/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/wendy_v2/` (rig root) or other directories
...
**Your mail address:** `wendy_v2/polecats/furiosa`
**Your rig:** wendy_v2
**Your Witness:** `wendy_v2/witness`
...
| Ask Witness for help | `gt mail send wendy_v2/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`wendy_v2/witness`) when:
...
```bash
gt mail send wendy_v2/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
